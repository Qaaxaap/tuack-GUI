...
export default function ArgsEditorDialog({ value, onSave, onClose }: Props) {
  ...
  return (
    <Dialog open onOpenChange={(o) => {
      ...
      <DialogContent className="w-[min(520px,90vw)] rounded-lg p-4">
        <div className="text-sm" style={{ color: "var(--text)" }}>测试点参数（args）</div>
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button variant="default" onClick={save}>确定</Button>
        </div>
      </DialogContent>
    </Dialog>
  );
